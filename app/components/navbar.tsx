  ...
  return (
    <>
      ...
      <div className="lg:hidden flex">
        <div
          className={`fixed top-0 right-0 h-full w-[250px] bg-white dark:bg-[#121212] transform transition-transform duration-500 z-50 ${
            menuOpen ? "translate-x-0" : "translate-x-full"
          } overflow-y-auto text-black dark:text-white`}
        >
          {/* Close button */}
          <div className="flex justify-between items-center px-2 py-4 dark:text-[#ffff] text-black">
            <div className="flex items-center space-x-1 focus:outline-none text-black dark:text-[#ffff]">
              <div className="flex items-center gap-[5px]">
                <span>
                  <Radius />
                </span>
